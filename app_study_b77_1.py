"""
DS Project - Banking77 Study App — Slice 1 of 4

100% Banking77 queries, DS system.
Participants in this app see queries 1–4 (small), 1–8 (medium), or 1–12 (large).# Deploy as its own Streamlit Cloud app; set STUDY_SET in Streamlit secrets.
